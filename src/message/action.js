 ...
 * @constructor
 * @see Action(String)
 * @see See <a href="https://wiki.asterisk.org/wiki/display/AST/Asterisk+11+ManagerAction_MuteAudio</a>.
 * @property {String} Channel Channel to transfer
 * @property {String} Exten Extension to transfer to
 * @property {String} Context Context to transfer to
 * @property {String} Priority Priority to transfer to
 ...
 */
function MuteAudio() {
	MuteAudio.super_.call(this, 'MuteAudio');
}
 ...
 * @constructor
 * @see Action(String)
 * @see See <a href="https://wiki.asterisk.org/wiki/display/AST/ManagerAction_MixMonitorMute">https://wiki.asterisk.org/wiki/display/AST/ManagerAction_MixMonitorMute</a>.
 * @property {String} Mute Channel monitor on this channel
 * @augments Action
 */
function MixMonitorMute() {
	MixMonitorMute.super_.call(this, 'MixMonitorMute');
}
 ...
 */
function BridgeList() {
	BridgeList.super_.call(this, 'BridgeList');
}
 ...
 * @constructor
 * @see Action(String)
 * @param {String} Bridge Uniqueid. The value of the "BridgeUniqueid" key.
 * @augments Action
 */
function BridgeInfo(BridgeUniqueid) {
	BridgeInfo.super_.call(this, 'BridgeInfo');
	this.set('BridgeUniqueid', BridgeUniqueid);
}
